...
contract StarNotary is ERC721 {
    constructor() ERC721("Claim Starz", "STRZ") {
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender, "Star 1 should be owner by sender");
        //2. You don't have to check for the price of the token (star)
        //3. Get the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId1)
        address star1Owner = ownerOf(_tokenId1);
        address star2Owner = ownerOf(_tokenId2);
        //4. Use _transferFrom function to exchange the tokens.
        _transfer(star1Owner, star2Owner, _tokenId1);
        _transfer(star2Owner, star1Owner, _tokenId2);
    }

        // Implement Task 1 Transfer Stars
    function transferStar(address _to1, uint256 _tokenId) public {
        //1. Check if the sender is the ownerOf(_tokenId)
        require(ownerOf(_tokenId) == msg.sender, "Star not owner by sender");
